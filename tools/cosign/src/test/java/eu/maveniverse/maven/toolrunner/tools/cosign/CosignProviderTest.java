...
public class CosignProviderTest {
    @Test
    void isolated() throws IOException {
        ...
        try (ToolManager toolManager = ToolManager.create(Config.builder()
                ...
                .build())) {
            assertTrue(toolManager.supportedToolNames().contains(CosignProvider.NAME));

            Optional<ToolHandler> maybeHandler = toolManager.selectToolByName("cosign");
